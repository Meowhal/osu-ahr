...
describe("CommandParserTest", function () {
    ...
    describe("ParseBanchoResponse tests", () => {
        ...
        it("PlayerMovedSlot test", () => {
            let v = CommandParser_1.parser.ParseBanchoResponse("azi03 moved to slot 6");
        ...
        it("MpHostChanged test", () => {
            let v = CommandParser_1.parser.ParseBanchoResponse("Changed match host to Brena_Pia");
        ...
        it("RemovedReferee test", () => {
            let v = CommandParser_1.parser.ParseBanchoResponse("Removed damn from the match referees");
            chai_1.assert.equal(v.type, CommandParser_1.BanchoResponseType.RemovedReferee);
            chai_1.assert.equal(v.params[0], "damn");
        });
        it("kick player test", () => {
            let v = CommandParser_1.parser.ParseBanchoResponse("Kicked damn from the match");
        ...
        it("FinishStartTimer test", () => {
            let v = CommandParser_1.parser.ParseBanchoResponse("Good luck, have fun!");
            chai_1.assert.equal(v.type, CommandParser_1.BanchoResponseType.FinishStartTimer);
        });
        it("AbortedStartTimer test", () => {
            let v = CommandParser_1.parser.ParseBanchoResponse("Countdown aborted");
