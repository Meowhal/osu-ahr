...
describe("Integrated Plugins Tests", function () {
    ...
    describe("selector and skipper tests", function () {
        async function setup(selectorOption = {}, skipperOption = { afk_check_interval_ms: 0 }) {
            ...
            const selector = new plugins_1.AutoHostSelector(li.lobby, selectorOption);
            const skipper = new plugins_1.HostSkipper(li.lobby, skipperOption);
        ...
        it("skip to test", async () => {
            ...
            let m = "*skipto p4";
            chai_1.assert.isTrue(parsers_1.parser.IsChatCommand(m));
