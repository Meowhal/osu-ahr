...
class FakeBeatmapFetcher {
    constructor() {
        ...
        this.id = 100;
        this.beatmapset = this.setBeatmapProperties(this.id, 'test', Modes_1.PlayMode.Osu, 100, 4);
    }
    setBeatmapProperties(id, title, mode, total_length, difficulty_rating) {
    ...
    async getBeatmapset(id) {
        ...
        if (id < 0) {
            throw new BeatmapRepository_1.FetchBeatmapError(BeatmapRepository_1.FetchBeatmapErrorReason.FormatError);
        }
        return this.beatmapset;
    }
}
exports.FakeBeatmapFetcher = FakeBeatmapFetcher;
//# sourceMappingURL=FakeBeatmapFetcher.js.map