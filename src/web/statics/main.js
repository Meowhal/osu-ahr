...
function AppendLog(log) {
  ...
  let spMsg = document.createElement("span");
...
function updateClicked() {
  let value = document.getElementsByName("mapid")[0].value;
